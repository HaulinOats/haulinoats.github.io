            ...
            questionItem: [
              {
                ...
                panswer: ["HTML 4.1", "HTML 4", "HTML 4.01", "HTML 4.9"],
                aanswer: "HTML 4.01",
              },
              {
                question: "Which doctype is correct for HTML5?",
                panswer: ["!DOCTYPE HTML PUBLIC '-//W3C//DTD HTML 5.0//EN' 'http://www.w3.org/TR/html5/strict.dtd'", "!DOCTYPE HTML5", "!DOCTYPE html", "!DOCTYPE html5.0"],
                aanswer: "!DOCTYPE html",
              },
              {
                question: "In HTML5, which element is used to group heading elements?",
                panswer: ["hgroup", "group", "headings", "header"],
                aanswer: "header",
              },
              {
                question: "Which of the following elements is no longer supported in HTML5?",
                panswer: ["q", "menu", "font", "ins"],
                aanswer: "font",
              },
              {
                question: "Which of the following elements is no longer supported in HTML5?",
                panswer: ["base", "cite", "acronym", "abbr"],
                aanswer: "acronym",
              },
              {
                question: "In HTML5, onblur and onfocus are:",
                panswer: ["Style attributes", "HTML elements", "Event attributes", "Element attributes"],
                aanswer: "Event attributes",
              },
              {
                question: "What is the correct HTML5 element for playing video files?",
                panswer: ["media", "video", "movie", "mpeg4"],
                aanswer: "video",
              },
              {
                question: "What is the correct HTML5 element for playing audio files?",
                panswer: ["mp3", "sound", "audio", "wav"],
                aanswer: "audio",
              },
              {
                question: "Which attribute for 'script' elements is no longer required in HTML5?",
                panswer: ["src", "type", "href", "rel"],
                aanswer: "type",
              },
              {
                question: "In HTML5, which method is used to get the current location of a user?",
                panswer: ["getPosition()", "getCurrentPosition()", "getUserPosition()", "getCoordinates()"],
                aanswer: "getCurrentPosition()",
              },
              {
                question: "The new HTML5 global attribute, 'contenteditable' is used to:",
                panswer: ["Update content from the server", "Specifies a context menu for an element. The menu appears when a user right-clicks on the element", "Return the position of the first found occurrence of content inside a string", "Specify whether the content of an element should be editable or not"],
            ...
            questionItem: [
              {
                ...
                panswer: ["Creative Style Sheets", "Computer Styling Syntax", "Cascading Style Sheets", "Colorful Style Sheets"],
                aanswer: "Cascading Style Sheets",
              },
              {
                question: "What is the proper HTML for referring to an external style sheet?",
                panswer: ["<link rel='stylesheet' type='text/css' href='mystyle.css'>", "<style src='mystyle.css'>", "<stylesheet>mystyle.css</stylesheet>", "<script src='mystyle.css'></script>"],
                aanswer: "<link rel='stylesheet' type='text/css' href='mystyle.css'>",
              },
              {
                question: "Where in an HTML document is the correct place to refer to an external style sheet?",
                panswer: ["In the 'body' section", "At the end of the document", "In the 'head' section", "At the top of the document"],
                aanswer: "In the 'head' section",
              },
              {
                question: "Which HTML element is used to define an internal stylesheet?",
                panswer: ["<css>", "<style>", "<script>", "<cascade>"],
                aanswer: "<style>",
              },
              {
                question: "Which HTML attribute is used to define inline styles?",
                panswer: ["styles", "class", "font", "style"],
                aanswer: "style",
              },
              {
                question: "Which is the correct CSS syntax?",
                panswer: ["body:color=black;", "{body:color=black;}", "{body;color:black;}", "body {color: black;}"],
                aanswer: "body {color: black;}",
              },
              {
                question: "How do you insert a comment in a CSS file?",
                panswer: ["// this is a comment //", "// this is a comment", "/* this is a comment */", "' this is a comment"],
                aanswer: "/* this is a comment */",
              },
              {
                question: "Which property is used to change the background color?",
                panswer: ["color", "background-color", "bgcolor", "bg-color"],
                aanswer: "background-color",
              },
              {
                question: "How do you add a background color for all 'h1' elements?",
                panswer: ["all.h1 {background-color:#FFFFFF;}", "h1.all {background-color:#FFFFFF;}", "h1 {background-color:#FFFFFF;}", "h1 {bg-color:#FFFFFF;}"],
                aanswer: "h1 {background-color:#FFFFFF;}",
              },
              {
                question: "Which CSS property is used to change the text color of an element?",
                panswer: ["text-color", "color", "fgcolor", "font-color"],
                aanswer: "color",
              },
              {
                question: "Which CSS property controls the text size?",
                panswer: ["text-style", "font-size", "font-style", "text-size"],
                aanswer: "font-size",
              },
              {
                question: "What is the correct CSS syntax for making all the <p> elements bold?",
                panswer: ["<p style='font-size:bold;'>", "<p style='text-size:bold;'>", "p {text-size:bold;}", "p {font-weight:bold;}"],
                aanswer: "p {font-weight:bold;}",
              },
              {
                question: "How do you display hyperlinks without an underline?",
                panswer: ["a {text-decoration:no-underline;}", "a {text-decoration:none;}", "a {underline:none;}", "a {decoration:no-underline;}"],
                aanswer: "a {text-decoration:none;}",
              },
              {
                question: "How do you make each word in a text start with a capital letter?",
                panswer: ["You can't do that with CSS", "text-transform:capitalize", "text-transform:uppercase", "font-style:uppercase"],
                aanswer: "text-transform:capitalize",
              },
              {
                question: "Which property is used to change the font of an element?",
                panswer: ["Both font-family and font can be used", "font", "font-family", "font-type"],
                aanswer: "Both font-family and font can be used",
              },
              {
                question: "How do you make the text bold?",
                panswer: ["font-weight:bold;", "font:bold;", "style:bold;", "font-bold:true"],
              ...
              },
              {
                ...
                panswer: ["border-width:10px 1px 5px 20px;", "border-width:10px 5px 20px 1px;", "border-width:5px 20px 10px 1px;", "border-width:10px 20px 5px 1px;"],
                aanswer: "border-width:10px 1px 5px 20px;",
              },
              {
                question: "Which property is used to change the left margin of an element?",
                panswer: ["margin-left", "indent", "padding-left", "left-margin"],
                aanswer: "margin-left",
              },
              {
                question: "How do you make a list that lists its items with squares?",
                panswer: ["list-style-type: square;", "list-type: square;", "list: square;", "list: box"],
            ...
            questionItem: [
              {
                ...
                panswer: ["$var1 = 'a' + 'b';", "$var1 = 'a'.'b';", "$var1 = 'a' JOIN 'b';", "$var1 = 'a'++'b';"],
                aanswer: "$var1 = 'a'.'b';",
              },
              {
                question: "Which is NOT a valid assignement operator?",
                panswer: ["$a -= $a;", "$a <= $a;", "$a *= $a;", "$a += $a;"],
                aanswer: "$a <= $a;",
              },
              {
                question: "What is the difference between 'include' and 'require'?",
                panswer: ["Include only includes the HTML in the file, while require includes the PHP code too.", "Require only includes the HTML in the file, while include imports the HTML and PHP code.", "Require will stop executing as soon as an error is reached, and include will continue executing the code after the error.", "Include will stop executing as soon as an error is reached, and require will continue executing the code after the error."],
              ...
              },
              {
                ...
                panswer: ["else if", "and if", "elif", "or if"],
                aanswer: "else if",
              },
              {
                question: "Which of these is not a valid statement?",
                panswer: ["if($a === '7') { }", "if($a != 8) { }", "if($a NEQ 8) { }", "if(!$a) { }"],
                aanswer: "if($a NEQ 8) { }",
              },
              {
                question: "Which is the correct way to start a function?",
                panswer: ["function testFunc()", "function testFunc{}", "function testFunc[]", "def testFunc{}"],
              ...
              },
              {
                ...
                panswer: ["$myFileContents = fread($a, 20);", "$myFileContents = fread(20,$a);", "$myFileContents = read(20,$a);", "$myFileContents = read($a, 20);"],
                aanswer: "$myFileContents = fread($a, 20);",
              },
              {
                question: "How do you write contents to a file?",
                panswer: ["output ('some content');", "echo ('some content');", "write('some content');", "fwrite('some content');"],
                aanswer: "fwrite('some content');",
              },
              {
                question: "What function do you use to delete a file in PHP?",
                panswer: ["delete()", "fdelete()", "unlink()", "remove()"],
                aanswer: "unlink()",
              },
              {
                question: "What function can you use to transfer an uploaded file to a new location?",
                panswer: ["transfer()", "move_uploaded_file()", "move_file()", "transfer_file()"],
                aanswer: "move_uploaded_file()",
              },
              {
                question: "PHP is an acronym for:",
                panswer: ["Pre Hypertext Processor", "Post Hypertext Processor", "PHP Hypertext Preprocessor", "Post Hypertext Preprocessor"],
                aanswer: "PHP Hypertext Preprocessor",
              },
              {
                question: "What type of language is PHP?",
                panswer: ["Client side", "Server side", "Windows side", "Controller side"],
                aanswer: "Server side",
              },
              {
                question: "Which of the following is a valid PHP script tag:",
                panswer: ["<PHP PHP>", "<?php php?>", "<php></php>", "<?php ?>"],
                aanswer: "<?php ?>",
              },
              {
                question: "Which of the following does NOT provide an output to the screen?",
                panswer: ["to_screen", "echo", "print_r", "print"],
                aanswer: "to_screen",
              },
              {
                question: "Which of the following is NOT a valid variable name in PHP?",
                panswer: ["$camelCase", "$B_Y_E", "$2cat", "$something"],
                aanswer: "$2cat",
              },
              {
                question: "Which of the following is NOT a PHP variable scope:",
                panswer: ["local", "global", "static", "defined"],
                aanswer: "defined",
              },
              {
                question: "Which is NOT true about integers in PHP?",
                panswer: ["An integer must have at least one digit (0-9)", "An integer can contain comma or blanks", "An integer must not have a decimal point", "An integer can be either positive or negative"],
                aanswer: "An integer can contain comma or blanks",
              },
              {
                question: "The strlen() function in PHP:",
                panswer: ["returns the length of a string, in characters", "searchs for a specified character or text within a string", "returns the number of words in a string", "randomizes order of letters in a string"],
                aanswer: "returns the length of a string, in characters",
              },
              {
                question: "The strpos() function in PHP:",
                panswer: ["returns the length of a string, in characters", "returns the number of words in a string", "randomizes order of letters in a string", "searchs for a specified character or text within a string"],
              ...
              },
              {
                ...
                panswer: ["Computes the difference of arrays using keys for comparison", "Pushes one or more elements onto the end of an array", "Fetches the key of an array", "Filters elements of an array using a callback function"],
                aanswer: "Fetches the key of an array",
              },
              {
                question: "What function would rearrange an array backwards?",
                panswer: ["array_backward", "array_reverse", "array_rekey", "array_diff"],
              ...
              },
              {
                ...
                panswer: ["array_key_exists", "has_value", "array_value_exists", "in_array"],
                aanswer: "has_value",
              },
            ],
          },
            ...
            questionItem: [
              {
                ...
                panswer: ["the % sign", "the ? Sign", "the $ sign", "the jQ sign"],
                aanswer: "the $ sign",
              },
              {
                question: "With jQuery, look at the following selector: $('div'). What does it select?",
                panswer: ["All div elements", "The first div element", "The last div element", "nothing"],
                aanswer: "All div elements",
              },
              {
                question: "jQuery is a library for:",
                panswer: ["home scripting", "server scripting", "TPS scripting", "client scripting"],
                aanswer: "client scripting",
              },
              {
                question: "What code sets all 'p' elements background color to red?",
                panswer: ["$('p').css('background-color','red');", "$('p').style('background-color','red');", "$('p').layout('background-color','red');", "$('p').manipulate('background-color','red');"],
                aanswer: "$('p').css('background-color','red');",
              },
              {
                question: "With jQuery, look at the following selector: $('div.intro'). What does it select?",
                panswer: ["All div elements with class='intro'", "The first div element with class='intro'", "All div elements with id='intro'", "The first div element with id='intro'"],
                aanswer: "All div elements with class='intro'",
              },
              {
                question: "Which jQuery method is used to hide selected elements?",
                panswer: ["visible(false)", "hidden()", "hide()", "display(none)"],
                aanswer: "hide()",
              },
              {
                question: "Which jQuery method is used to set one or more style properties for selected elements?",
                panswer: ["html()", "style()", "css()", "styles()"],
                aanswer: "css()",
              },
              {
                question: "Which jQuery method is used to perform an asynchronous HTTP request?",
                panswer: ["jQuery.ajax()", "jQuery.ajaxAsync()", "jQuery.ajaxSetup()", "jQuery.AJAX()"],
                aanswer: "jQuery.ajax()",
              },
              {
                question: "What is the correct jQuery code for making all div elements 100 pixels high?",
                panswer: ["$('div').yPos(100)", "$('div').height(100)", "$('div').height='100'", "$('div').xPos(100)"],
                aanswer: "$('div').height(100)",
              },
              {
                question: "Which is true:",
                panswer: ["To use jQuery, you do not have to do anything. Most browsers (Internet Explorer, Chrome, Firefox and Opera) have the jQuery library built in the browser", "To use jQuery, you can refer to a hosted jQuery library at Google", "To use jQuery, you must buy the jQuery library at www.jquery.com", "jQuery is built into core Javascript"],
              ...
              },
              {
                ...
                panswer: ["switch()", "switchClass()", "toggleClass()", "altClass()"],
                aanswer: "toggleClass()",
              },
              {
                question: "Look at the following jQuery selector: $('div#intro .head'). What does it select?",
                panswer: ["All div elements with id='intro' or class='head'", "All elements with class='head' inside the first div element with id='intro'", "The first element with id='head' inside any div element with class='intro'", "All div elements with a parent of 'head'"],

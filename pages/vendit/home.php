								...
								<div id="blog_container">
									<div id="blog_content">
										...
										<div id="blog">
											...
											<p class="blog_text">
												Diablo 3 and Max Payne 3, two of the most anticipated games of the year, has been released on the same day as both are expected to spark video games sales this month.

Diablo 3 an action role playing game, the third installment in the Diablo franchise, has raked in the most pre ordered PC game of all time for Activision Blizzard.

At the same time, Max Payne 3 have put tremendous marketing efforts to make it the biggest and boldest game in Rockstar Game's history.

Based on reports from VGChartz, Diablo 3 dominated the rankings with nearly 824,000 pre-order players. 
											</p>
										</div>
									</div>
								</div>
					...
					<div id="footer_container">
						<div id="footer_content">
							<div id="footer">
								This site was developed by the VendIT team and is not intended for commercial use.   
							</div>
						</div>
					</div>
				</div>
